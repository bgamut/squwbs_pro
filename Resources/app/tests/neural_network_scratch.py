...
prev_hidden=2*np.random.random((X.shape[1] + 1, num_hidden)) - 1
prev_output=2*np.random.random((num_hidden + 1, y.shape[1])) - 1
...
for i in range(num_iterations):
    ...
    prev_hidden=hidden_weights.copy()
    prev_output=output_weights.copy()
